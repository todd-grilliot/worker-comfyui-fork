...
### downloading models used to live here ###  
...
# Add custom nodes
RUN comfy-node-install comfyui-videohelpersuite comfyui_controlnet_aux 
RUN comfy node install comfyui-pixelart-detector